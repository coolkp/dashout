...
import UserImg from "../assets/images/piazza.png";
        ...
        <Nav className="navbar navbar-expand-lg fixed-top is-white is-dark-text">
          ...
          <Container className="navbar-nav ml-auto">
            <Container className="user-detail-section">
              <span className="pr-2">Hi, Vidish</span>
              <span className="img-container">
                <img src={UserImg} className="rounded-circle profile-icon" alt="user" />
              </span>
            </Container>
          </Container>
        </Nav>
          ...
          <Container className="row">
            ...
            <Container className="col-lg-3 col-sm-6 is-light-text mb-4">
              <Container className="card grid-card is-card-dark">
                <Container className="card-heading">
                  <Container className="is-dark-text-light letter-spacing text-small">
                    Revenue from Household supplies
                  </Container>
                    ...
                    <Container className="chart-container full-height">
                      <ReactFC
                        {...{
                          ...
                          dataSource: {
                            chart: {
                              caption: "Time Spent in Store more than 30 mins",
                              theme: "ecommerce",
                    ...
                    <Container className="chart-container full-height">
                      <ReactFC
                        {...{
                          ...
                          dataSource: {
                            chart: {
                              caption: "Purchase value above 30$",
                              theme: "ecommerce",
                              defaultCenterLabel: `${
                    ...
                    {...{
                      ...
                      dataSource: {
                        chart: {
                          ...
                          subCaption: "By Purchase Category"
                        },
